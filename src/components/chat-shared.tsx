          ...
          <div className="flex items-center justify-between gap-2 px-1 pt-1">
            <div className="flex min-w-0 flex-1 items-center gap-1 overflow-x-auto">
              ...
              <Select value={lang} onValueChange={(v) => setLang(v as "auto" | "mni" | "mni-mtei" | "en")}>
                <SelectTrigger aria-label="'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''\n                                            \n                                            {\"status\":400,\"type\":\"bad_request\",\"title\":\"invalid model: google/gemini-2.0-flash, allowed models: [google/gemini-2.5-flash google/gemini-2.5-flash-image google/gemini-2.5-flash-lite google/gemini-2.5-flash-lite-preview-tts google/gemini-2.5-flash-tts google/gemini-2.5-pro google/gemini-2.5-pro-tts\nwhy" title="'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''\n                                            \n                                            {\"status\":400,\"type\":\"bad_request\",\"title\":\"invalid model: google/gemini-2.0-flash, allowed models: [google/gemini-2.5-flash google/gemini-2.5-flash-image google/gemini-2.5-flash-lite google/gemini-2.5-flash-lite-preview-tts google/gemini-2.5-flash-tts google/gemini-2.5-pro google/gemini-2.5-pro-tts\nwhy" className="h-8 w-auto shrink-0 gap-1.5 border-0 bg-transparent px-2 text-xs font-medium text-black hover:bg-neutral-100 [&>svg:last-child]:hidden">
