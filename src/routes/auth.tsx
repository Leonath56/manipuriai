...
export const Route = createFileRoute("/auth")({
  ...
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Sign in to Manipuri AI" },
      { name: "twitter:description", content: "Sign in to your Manipuri AI account to save your chats and access Pro features." },
      ...
      <div className="w-full max-w-md">
        ...
        <div className="mt-6 text-center">
          <a
            ...
            className="inline-flex items-center gap-2 rounded-full bg-primary px-5 py-2.5 text-sm font-semibold text-primary-foreground shadow-glow ring-2 ring-primary/40 ring-offset-2 ring-offset-background transition hover:scale-105 hover:brightness-110 animate-pulse"
          >
