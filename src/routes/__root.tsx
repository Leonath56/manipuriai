...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Manipuri AI is the first ChatGPT-style AI chatbot that speaks Meiteilon (Manipuri) and English fluently. Supports Latin, Bengali & Meitei Mayek script. Free to try — voice, image generation, and memory." },
    ...
    links: [
      ...
      { rel: "icon", href: "/logo.png?v=3", type: "image/png", sizes: "512x512" },
    ...
    scripts: [
      {
        children: `
          function loadDeferredStyles() {
            ...
            addStyle('https://fonts.googleapis.com/css2?family=Outfit:wght@400;500;600;700;800&family=Figtree:wght@400;500;600;700&family=Instrument+Serif:ital@0;1&family=Inter:wght@400;500;600;700&display=swap');
